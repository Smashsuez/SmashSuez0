...
const index = ({ orders, products }) => {
  ...
  const handleDeleteOders = async (orderId) => {
    try {
  ...
  const handleDeleteProducts = async (orderId) => {
    try {
      ...
      setProductsList(newProductres.data); // update the orders list with the new data
    } catch (error) {
      console.error(error);
  ...
  return (
    ...
    {ordersList.map((order) => (
        <tr key={order._id} className={styles.tr}>
          ...
          <td>
            <button className={styles.button} onClick={() => handleDeleteOders(order._id)}>Delete</button>
          </td>
        </tr>
